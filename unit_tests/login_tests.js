function testLoginAction(){
	...
	// a função de sucesso é passada como argumento
...
function testLoginSuccessCallback(data){
	...
	equals(response['email'], 'mads@fe.up.pt');
	deepEqual(response['projs'], new Array('1', '2', '23', '24', '25'));
	equals(response['name'], 'MADS 2011');
